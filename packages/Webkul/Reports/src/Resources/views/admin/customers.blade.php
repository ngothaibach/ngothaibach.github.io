    ...
    <div class="content" style="height: 100%;">
        <div class="page-header">
            <div class="page-title">
                <h1>Báo cáo bán hàng theo khách hàng</h1>
            </div>
        </div>
...
@push('scripts')
    <script type="text/x-template" id="report-form-template">
        <form action="{{ route('reports.admin.export_customers_report')}}" class="form newtopic" method="POST" @submit.prevent="onSubmit">
            @csrf()
            <div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="w3-input" name="inventory_id" style="width: 200px">
                ...
                {{-- <div class="mb-3">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="w3-input" id="sale_id" name ="sale_id" style="width: 200px">
                                <option value="0">Tất cả</option>
                                <option 
