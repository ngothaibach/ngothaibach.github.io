                    ...
                    <accordian :title="'{{ __('admin::app.settings.inventory_sources.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                <label for="inventory-name" class="required">{{ __('admin::app.settings.inventory_sources.name') }}</label>
                            ...
                            <div class="control-group">
                                <label for="inventory-description">{{ __('admin::app.settings.inventory_sources.description') }}</label>
                            ...
                            <div class="control-group">
                                <label for="inventory-status">{{ __('admin::app.settings.inventory_sources.status') }}</label>
